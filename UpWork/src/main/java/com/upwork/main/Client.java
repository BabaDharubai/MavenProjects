			...
			case 2:
				...
				if (user != null) {
					if (user.getType().equalsIgnoreCase("employer")) {
						System.out.println("1.Book a freelancer\n2.See previous Bookings");
						...
						case 1:
							...
							break;
						case 2:
							userService.bookingDetails(user).forEach(System.out::println);
							break;
						default:
						...
						switch (option) {
						case 1:
							System.out.println("Enter your updating parameter\n1.cost\n2.skill\n3.Experience");
							option = sc.nextInt();
							sc.nextLine();
							switch (option) {
							case 1:
